...
function App() {
  ...
  const handleLeaveMessageClick = () => setShowOverlay(true);
    ...
    <div className="relative min-h-screen p-4 grid place-items-center">
      ...
      >
        <div className="col-span-2 row-span-2 md:col-span-4">
          <Card><MainProfileCard /></Card>
        </div>
        <div className="col-span-2 md:col-span-4">
          <Card><TechStackCard /></Card>
        </div>
        <div className="col-span-2 row-span-3 md:col-span-4 md:row-span-2">
          <Card><PratGPTCard /></Card>
        </div>
        <div className="col-span-2 row-span-2">
          <Card><SocialsCard /></Card>
        </div>
        <div className="col-span-2 row-span-2">
          <Card><MainProjectCard /></Card>
        </div>
        <div className="col-span-2 md:col-span-2">
          <Card><GIFCard /></Card>
        </div>
        <div className="col-span-2 md:col-span-2">
          <Card><ContactCard onClick={handleLeaveMessageClick} /></Card>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col h-auto max-h-[80vh] overflow-y-auto p-6">
              <h2 className="text-xl lg:text-2xl font-bold mb-2 text-center text-white">Let's have a chat!</h2>
              ...
              <form action="https://formspree.io/f/mbljkqpb" onSubmit={handleFormSubmit} method="POST" className="space-y-4">
                <div>
                  <label htmlFor="name" className="block text-sm text-gray-200 mb-1">Name</label>
                  <input type="text" id="name" name="name" required placeholder="Name" className="w-full border-b border-gray-500 bg-transparent text-white placeholder-gray-500 focus:outline-none focus:border-blue-500" />
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm text-gray-200 mb-1">Email</label>
                  <input type="email" id="email" name="email" required placeholder="Email" className="w-full border-b border-gray-500 bg-transparent text-white placeholder-gray-500 focus:outline-none focus:border-blue-500" />
                </div>
                <div>
                  <label htmlFor="message" className="block text-sm text-gray-200 mb-1">Message</label>
                  <textarea id="message" name="message" rows="4" required placeholder="Type your message here" className="w-full border-b border-gray-500 bg-transparent placeholder-gray-500 focus:outline-none focus:border-blue-500 resize-none text-white"></textarea>
                </div>
                <button
                  type="submit"
                  className={`w-full py-2 rounded transition ${
                    isSent ? "bg-green-500 text-white" : isSubmitting ? "bg-blue-400 text-white cursor-not-allowed" : "bg-blue-500 text-white hover:bg-blue-600"
                  }`}
